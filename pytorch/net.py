...
class Encode(nn.Module):
    def __init__(self, ch1, ch2):
        ...
        layers = [ nn.Conv2d(ch1,ch2,kernel_size=3,stride=2,padding=1),
...
class My_Unet(nn.Module):
    def __init__(self, input_channel, class_num):
        ...
        self.conv6 = nn.Sequential( nn.Conv2d(128,128,kernel_size=4,stride=2),
            nn.ReLU(inplace=True),)
        
        self.deconv7 = nn.Sequential( nn.ConvTranspose2d(128,128,kernel_size=4,stride=2),
            nn.ReLU(inplace=True),
